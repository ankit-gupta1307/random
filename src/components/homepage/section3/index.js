      	...
      	<Grid>
      		...
      		<Row className="mobileVersion">
      		  ...
      		  <Col lg={5} md={5} sm={5} xs={12} lgOffset={7} mdOffset={7} smOffset={7}>
      		    <p className="mobileTime">The time is now for companies to buy zero carbon energy. Our clean energy concierge sources and manages renewables for you and your supply chain.</p>
      		  </Col>
      		</Row>
